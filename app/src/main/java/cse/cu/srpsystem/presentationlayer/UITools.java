...
public class UITools {
    ...
    public static void openDashboard(Context context, boolean refreshData) {
        Intent intent = null;
        switch (LoginBL.getInstance().getUser().getRole()) {
            case "Exam Controller":
                intent = new Intent(context, LoginDashboardExamController.class);
                break;
            case "Teacher":
                intent = new Intent(context, LoginDashboardTeacher.class);
                break;
            case "Student":
                intent = new Intent(context, LoginDashboardStudent.class);
                break;
            default:
