...
import cse.cu.srpsystem.logics.DistributionLogic;
import cse.cu.srpsystem.logics.StatusListener;
import cse.cu.srpsystem.logics.ThreadLogics;

public class DistributionDialog extends DialogFragment {
    ...
    public DistributionDialog setExam(int exam_id) {
        logic = new DistributionLogic(exam_id);
        return this;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        (examiners = layout.findViewById(R.id.spinner_examiner)).setAdapter(new ArrayAdapter<>(context, R.layout.sample_text, LocalDataHandler.getInstance(context).getTeachers()));
        ...
        (courses = layout.findViewById(R.id.spinner_courses)).setAdapter(new ArrayAdapter<>(context, R.layout.sample_text,
                LocalDataHandler.getInstance(context).getTheoryCoursesByExam(logic.getExamID())));
        ...
        (studentID = layout.findViewById(R.id.student_id)).setAdapter(autoCompleteAdapter = new ArrayAdapter<>(
                context, R.layout.sample_text, LocalDataHandler.getInstance(context).getStudentIDsByExam(logic.getExamID())
        ));
